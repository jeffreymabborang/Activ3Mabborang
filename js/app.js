    ...
    jokeButton.on('click', async function(e){
      //Do the magic here
        ...
        else
        {
            ...
            var answer= confirm("Isn't funny?");
            if(answer)
            {
                CountOfLaugh+=1;
                if(CountOfLaugh>2)
                {
                    ...
                    var DispText="Congratulations it's your lucky day my friend. Spread the good vibes, make everyone smile.";
                    div.append(reactImage);
                    var header=document.createElement('h3');
                    header.append(DispText);
                    div.append(header);
                }
                else
                {   
                    ...
                    div.append(reactImage);
                    var DispText="We're feelin' what you feel. It's okay, don't die yet. You can still breathe but not try to be funny right now of else ...";
                    div.append(reactImage);
                    var header=document.createElement('h3');
                    header.append(DispText);
                    div.append(header);
